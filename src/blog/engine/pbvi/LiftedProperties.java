...
public class LiftedProperties {
    ...
    public Map<RandFuncAppVar, Object> getProperties(){
        return properties;
    }
    ...
    private Map<Object, Object> findNgoSubstitution(
        ...
        Set<RandFuncAppVar> ngoprops = objToProperties.get(ngo);
        if (ngoprops == null){
            ngoprops = new HashSet<RandFuncAppVar>();
        }
